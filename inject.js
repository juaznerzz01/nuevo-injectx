...
const MODES = {
    AGGRESSIVE: {
        ...
        EMA_FAST: 8,
        EMA_SLOW: 34,
        MIN_SIGNAL_MS: 600,   // ~0.8s para confirmar
        STICK_MS: 2200,       // se queda pegada ~2.5s
        ALERT_GAP_MS: 5500,
        PROB_WINDOW: 4,
        VOL_WINDOW: 5,
        CONGESTION_TICKS: 2
    ...
    const PRICE_WINDOW_SIZE = 40;
    const MOVE_WINDOW_SIZE = 40;
   ...
   let fxProbEl = null;
    ...
    function sendPanelSnapshotToN8n(probRaw, trend, signal, stateLabel, freq) {
       ...
       const recentPrices = priceWindow.slice(-30);
        ...
        if (fxFreqEl) {
            fxFreqEl.textContent = `Freq: ${freq} (min ${dynamicMinFreq})`;
        }
